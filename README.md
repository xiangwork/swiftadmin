...
## 开源不易，连个星星都不舍得给，下个版本的admin.js和formdesign.js不会再开源，会压缩下！
## 什么时候星星到3K了，再考虑开源吧！！！！
![输入图片说明](public/upload/1.gif)
...
你可以在后台插件管理中安装你所需要的完整应用或者部分插件，注意安装完整应用的话<br/>
...
3. SwiftAdmin框架及相关官方插件，使用者只拥有本框架和插件的使用权，不具备著作权，故任何人不得使用SwiftAdmin软件来申请著作权
4. 本软件依法享有国家著作权保护，故使用本软件者不得恶意篡改本源码，包括但不限于（植入木马病毒，编写违法应用）进行恶意传播。
5. 不得对本软件进行恶意篡改或倒卖，不得对本软件进行二次包装后声称为自己的产品等，请尊重国家著作权法！
6. 如有商用祛除版权的需求，请购买域名授权，授权期间本软件作者有义务对授权者提供技术支持！
   
<font color="red">域名授权具体事宜，请参考官网授权查询页面</font>
