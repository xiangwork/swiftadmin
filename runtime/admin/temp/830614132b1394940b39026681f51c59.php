<?php /*a:3:{s:64:"C:\wwwroot\demo.swiftadmin.net\app\admin\view\index\basecfg.html";i:1649342646;s:64:"C:\wwwroot\demo.swiftadmin.net\app\admin\view\public\header.html";i:1649307415;s:64:"C:\wwwroot\demo.swiftadmin.net\app\admin\view\public\footer.html";i:1647424835;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="layui-tab-content">
                            ...
                            <div class="layui-tab-item layui-show">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <button type="button" class="layui-btn layui-btn-normal" lay-upload="logo"
                                        data-url="<?php echo url('/upload/logo'); ?>" callback="test">
                            ...
                            <div class="layui-tab-item">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="radio" name="system_alogs" value="1" title="开启" <?php if($config['system_alogs'] == 1): ?> checked <?php endif; ?> >
                                        <input type="radio" name="system_alogs" value="0" title="关闭" <?php if($config['system_alogs'] == 0): ?> checked <?php endif; ?>>
                                    </div>
                            ...
                            <div class="layui-tab-item">
                                ...
                                <div class="layui-form-item ">
                                    ...
                                    <div class="layui-form-mid layui-word-aux">* <?php echo __('文件是否上传至FTP后删除本地文件。不建议开启！'); ?></div>
                                </div>
                                ...
                                <div class="layui-form-item ">
                                    ...
                                    <label class="layui-form-label"><?php echo __('自动下载图片'); ?></label>
                                    <div class="layui-input-inline">
                                        <select name="upload_http_auto">
                                            <option value="1" <?php if($config['upload_http_auto'] == '1'): ?>
                                                selected="" <?php endif; ?> ><?php echo __('开启'); ?></option>
                                            <option value="0" <?php if($config['upload_http_auto'] == '0'): ?>
                                                selected="" <?php endif; ?> ><?php echo __('关闭'); ?></option>
                                        </select>
                                    </div>
                                    <div class="layui-form-mid layui-word-aux">
                                        <font color="red">* <?php echo __('开启后，发表内容会自动将图片下载或上传云空间'); ?></font>
                                    </div>
                                </div>
                                ...
                                <div class="layui-cloud-oss" <?php if($config['cloud_status'] == '0'): ?>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="cloud_type" data-selector="aliyun,qcloud"
                                                lay-filter="selectStatus">
                                                <option value="aliyun" <?php if($config['cloud_type'] == 'aliyun'): ?>
                                                    selected="" <?php endif; ?> ><?php echo __('阿里云OSS'); ?></option>
                                                <option value="qcloud" <?php if($config['cloud_type'] == 'qcloud'): ?>
                                    ...
                                    <div class="aliyun" <?php if($config['cloud_type'] != 'aliyun_oss'): ?>
                                        style="display:none;" <?php endif; ?> >
                                    ...
                                    <!-- 腾讯云上传 -->
                                    <div class="qcloud" <?php if($config['cloud_type'] != 'qcloud_oss'): ?>
                                        style="display:none;" <?php endif; ?> >
                                ...
                                <div class="upload_water" <?php if($config['upload_water'] == 0): ?>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <button type="button" class="layui-btn layui-btn-normal"
                                            lay-upload="upload_water_img" data-url="/upload/file"><?php echo __('上传图片'); ?></button>
                                    </div>
                                    ...
                                    <div class="layui-colla-item">
                                        ...
                                        <div class="layui-colla-content">
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">APP_ID</label>
                                                <div class="layui-input-inline">
                                                    <input type="text" name="mpwechat[secret_id]"
                                                        value="<?php echo htmlentities($config['mpwechat']['secret_id']); ?>" class="layui-input">
                                                </div>
                                                <div class="layui-form-mid layui-word-aux">*
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-inline">
                                                    <input type="text" name="mpwechat[secret_key]"
                                                        value="<?php echo htmlentities($config['mpwechat']['secret_key']); ?>" class="layui-input">
                                                </div>
                                                <div class="layui-form-mid layui-word-aux">
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-inline">
                                                    <input type="text" name="mpwechat[secret_token]"
                                                        value="<?php echo htmlentities($config['mpwechat']['secret_token']); ?>" class="layui-input">
                                                </div>
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-inline">
                                                    <input type="text" name="mpwechat[EncodingAESKey]"
                                                        value="<?php echo htmlentities($config['mpwechat']['EncodingAESKey']); ?>" class="layui-input">
                                                </div>
                                                <div class="layui-form-mid layui-word-aux">
                            ...
                            <div class="layui-tab-item">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        ...
                                        <?php endif; ?> >
                                        <input type="radio" name="user_register_style" value="regcode"
                                            title="<?php echo __('邀请码'); ?>" <?php if($config['user_register_style'] == 'regcode'): ?> checked
                                        <?php endif; ?> >
                                    </div>
                                    <div class="layui-form-mid layui-word-aux">
